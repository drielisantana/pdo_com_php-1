                        ...
                        foreach($resultados as $resultado) {
                            ...
                            echo '<tr>';
                                ...
                                echo    '<td class="d-flex flex-row justify-content-around">
                                            <a href="http://192.168.1.25/TRILHAS4/Andrieli/pdo_com_php/usuario_edita.php?id=' . $resultado->cod_usuario . '" class="text-warnig"><i class="far fa-edit"></i></a>

                                            <a href="http://192.168.1.25/TRILHAS4/Andrieli/pdo_com_php/alterastatus.php?id=' . $resultado->cod_usuario . '" class="text-danger"><i class="fas fa-trash-alt"></i></a>
                                        </td>';
                            echo '</tr>';
